...
export const edgeUpdate = new ValidatedMethod({
  ...
  validate: new SimpleSchema({
    imAnArray: Array,
    'imAnArray.$': [edgeUpdateSchema,    { 'edgeId': {type: String   }    },    {      'data.source': {        type: String,        label: 'The source of the edge',        optional :true      }    },    {      'data.target': {        type: String,        label: 'The target of the edge',        optional :true      }    }]
